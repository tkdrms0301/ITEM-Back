...
import kit.item.domain.mysql.it.ItDevice;
import kit.item.domain.mysql.market.*;
import kit.item.domain.mysql.point.PointHistory;
import kit.item.domain.mysql.point.Subscription;
import kit.item.domain.mysql.post.Comment;
import kit.item.domain.mysql.post.CommentReport;
import kit.item.domain.mysql.post.Post;
import kit.item.domain.mysql.post.PostReport;
import kit.item.domain.mysql.repair.Estimate;
import kit.item.domain.mysql.repair.RepairResultReport;
import kit.item.domain.mysql.repair.RepairServiceReview;
import kit.item.domain.mysql.repair.Reservation;
